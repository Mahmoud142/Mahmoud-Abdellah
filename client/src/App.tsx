...
import type { GitHubRepo, PortfolioData } from "./types";
...
function App() {
    ...
    useEffect(() => {
        ...
        async function loadPortfolioAndRepos() {
            try {
                const [portfolioResponse, reposResponse] = await Promise.all([
                ...
                const payload =
                    (await portfolioResponse.json()) as PortfolioData;
    ...
    useEffect(() => {
        function handleScroll() {
            setShowNavAvatar((previous) => {
                if (previous) {
                    return window.scrollY > avatarHideScrollY;
                }

                return window.scrollY > avatarShowScrollY;
            });
    ...
    }, [avatarHideScrollY, avatarShowScrollY]);
        ...
        return (
            <main className="shell status-shell">
                <section className="status-card">
                    ...
                    <p>Fetching typed content from the server.</p>
                </section>
            </main>
        );
    }
            ...
            <nav className="navbar">
                <div className="navbar-brand">
                    ...
                    <div className="navbar-brand-text">
                        <span className="navbar-name">{data.name}</span>
            ...
            <main className="shell">
                ...
                <section className="hero panel nav-section" id="home">
                    <div className="hero-copy">
                        ...
                        <p className="hero-blurb">{data.heroBlurb}</p>
